...
//console.log(butunSon); // 12 chiqishi kerak!
...
//let harflar = ["a", "b", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", "t", "u", "v", "x", "y", "z"];
//let ism = ["m", "y", "o", "h", "i", "r"]; 'harflar[0] harflar[1] harflar[2] harflar[3] harflar[19] harflar[16] harflar[0] harflar[23]  harflar[23] harflar[13] harflar[15]'
